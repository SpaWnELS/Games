...
class Game():   
    def __init__(self):
        ...
        self.pause_meteors_drawn = False
    ...
    def draw_buttons(self, screen, game_button=False):
        for button in But.Button.buttons:
            ...
            if (game_button):
                Met.Meteors.draw_button_meteor(button, screen, self)
        return
    ...
    def draw_corner_meteors(self, screen):
        Met.Meteors.draw_corner_meteor(screen, self)
        Met.Meteors.draw_corner_meteor(screen, self, True)
        return
    ...
    def draw_meteors(self, screen):
        Met.Meteors.draw_meteors(self, self, screen)
        return
    ...
    def add_word_meteor(self, word, screen):
        Met.Meteors.add_word_meteor(self, word, screen)
        return

    def pop_word_meteors(self, screen):
        Met.Meteors.pop_word_meteors(screen)
        return
